...
export const shopsData = {
  "zellerbaeck": {
    ...
    "description": "Bäckerei und Konditorei Zeller aus Friedrichshafen – Ein Familienbetrieb gegründet im Jahre 1899. Seit über 120 Jahren bewährter Handwerksbrauch.",
  ...
  "wirtshaus-zum-spreisel": {
    ...
    "description": "Traditionelle Odenwälder Küche. Seit über 40 Jahren Familienerfahrung.",
  ...
  "ristorante-giardino": {
    ...
    "description": "Authentische italienische Küche im Herzen von Heidelberg. Seit 1999 feine Nudelspezialitäten und Pizza.",
  ...
  "golden_spoon_germany": {
    ...
    "description": "Authentische indische und persische Spezialitäten. Fokus auf South Indian Specials und Biryanis.",
  ...
  "art_hotel": {
    ...
    "management": { "name": "Thomas Feiler", "title": "Geschäftsführer" },
    "locations": ["Grabengasse 7, 69117 Heidelberg"],
    "openingHours": {
      "breakfast_mo_fr": "06:30 - 10:00",
      "breakfast_sa_so_holidays": "07:00 - 11:00",
      "alacarte_thu_sat": "18:00 - 22:30 (Küche bis 21:30)",
      "groups": "Auf Anfrage auch an Ruhetagen geöffnet"
    },
    "offerings": ["Regionale Küche", "Saisonale Gerichte", "Frühstücksbuffet", "Lunch & Dinner"],
    "contact": { 
      "tel": "+49 6221 650060", 
      "tel_restaurant": "+49 6221 65006150",
      "email": "info@arthotel.de" 
    },
    "legal": { 
      "company": "ArtHotel Betriebs GmbH",
      "hrb": "Amtsgericht Mannheim", 
      "address": "Grabengasse 7, 69117 Heidelberg"
    },
    "recruitment_needs": ["Servicekraft", "Küchenhilfe", "Event-Management Support"],
    "special_features": ["Tischreservierung für Gruppen & Feiern", "Historische Lage", "Kombination mit Hotel-Übernachtung"]
  },

  "elvish_inn_heidelberg": {
    "name": "Elvish Inn – Essen, Trinken, Wohlfühlen",
    "logo": "/images/logos/elvis1.png",
    "description": "Moderne, mediterran inspirierte Küche im Herzen der Heidelberger Bahnstadt. All-Day Dining, Events und großzügige Sonnenterrasse.",
    "management": { "names": ["Irem Duran Busemann", "Holger Busemann"], "title": "Geschäftsführer" },
    "locations": ["Eppelheimerstraße 8, 69115 Heidelberg"],
    "openingHours": { "daily": "09:00 - 22:00", "lunch_time": "11:30 - 14:00" },
    "offerings": ["Mediterrane Klassiker", "Business-Lunch", "Frühstücksbuffet", "Kreative Cocktails", "Signature Drinks"],
    "pricing_highlights": { "lunch_menu": "10,90 €", "beefy_wrap": "15,50 €", "steak_vom_rind": "28,50 €", "fruehstuecksbuffet_pp": "19,50 €" },
    "event_capacity": { "total_area": "356 m²", "total_seats": 116, "indoor_seats": 76, "terrace_seats": 40 },
    "contact": { "tel": "06221 6599319", "email": "info@elvishinn.de", "website": "https://elvishinn.de" },
    "legal": { "company": "RemCorp GmbH", "hrb": "752658 Mannheim", "address": "Eppelheimerstraße 8, 69115 Heidelberg" }
  },

  "schulzi_heidelberg": {
    "name": "Schulzi – Bar & Pizzeria",
    "logo": "/images/logos/schulz.png",
    "description": "Italienisches Lebensgefühl im Herzen von Neuenheim. Berühmt für neapolitanische Pizza, Pasta und Sundowner-Aperitifs.",
    "management": { "names": ["Oliver Antes", "Joachim v. der Linde"], "title": "Geschäftsführer (v. der Linde & Antes GbR)" },
    "locations": ["Schulzengasse 6, 69120 Heidelberg"],
    "openingHours": { "daily": "12:00 - 00:00", "sundowner_time": "Ab 17:30 Uhr" },
    "offerings": ["Handwerkskunst Pizza (Neapolitanisch)", "Pasta-Spezialitäten", "Klassische & Signature Aperitivos", "Take-away für die Neckarwiese"],
    "menu_highlights": { "pizza_margherita": "9,50 €", "pizza_hellboy_hot": "14,50 €", "espresso_martini": "5,50 €" },
    "contact": { "tel": "+49 6221 9069115", "email": "info@schulzi-hd.de", "website": "https://schulzi-hd.de" },
    "legal": { "company": "v. der Linde & Antes GbR", "address": "Schulzengasse 6, 69120 Heidelberg", "ustId": "DE273882060" }
  },


  "moes_roadhouse_heidelberg": {
    "name": "Moe’s Roadhouse OHG Heidelberg",
    "logo": "/images/logos/moes.png",
    "description": "Authentisches amerikanisches Roadhouse-Flair im Herzen von Heidelberg. Spezialisiert auf saftige Burger aus US-Beef, Ribs, Steaks und original amerikanische Shakes.",
    "management": { "name": "Reza Salehi", "title": "Geschäftsführer" },
    "locations": ["Bergheimer Str. 147, 69115 Heidelberg", "Bismarckplatz, Heidelberg"],
    "openingHours": { "note": "Für Nachtschwärmer und Frühstücksliebhaber geeignet. Genaue Zeiten via Website." },
    "offerings": ["Echtes US-Beef Burger", "Saftige Ribs & Wings", "Amerikanisches Frühstück", "Original American Milkshakes"],
    "special_features": { "parking": "Kostenloses Parken für 5 Std. (Registrierung am Tisch erforderlich)" },
    "contact": { "tel": "+49 6221 6536068", "email": "info@moes-roadhouse.de", "website": "https://www.moes-roadhouse.de" },
    "legal": { "company": "Moe’s Roadhouse OHG", "ustId": "DE 32 340 / 34 523" }
  },

  "qube_hotel_bergheim": {
    "name": "Qube Hotel Bergheim (Boutique Hotel & Restaurant)",
    "logo": "/images/logos/qube.png",
    "description": "Persönlich geführtes 4-Sterne-Boutique-Hotel mit Fokus auf Design, Nachhaltigkeit und gehobene internationale Küche.",
    "management": { "name": "Johannes Arndt", "title": "Geschäftsführer" },
    "locations": ["Bergheimer Straße 74, 69115 Heidelberg"],
    "openingHours": { "breakfast": "06:30 - 11:00", "lunch_dinner": "12:00 - 22:00" },
    "offerings": ["First Class Hotelzimmer", "Gehobenes Restaurant", "Rooftop Terrace"],
    "contact": { "tel": "+49 6221 187990", "email": "bergheim@qube-heidelberg.de", "website": "https://qube-hotel-heidelberg.de/bergheim/" },
    "legal": { "company": "Qube Hotel Heidelberg", "ustId": "DE 302690242" }
  }
};