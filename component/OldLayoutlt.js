...
export default function OldLayoutlt({ frontmatter = {}, content = "", products = [], slug = "" }) {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 2, "name": frontmatter.title || frontmatter.keyword1, "item": `https://lemonskn.com/lt/${slug}` },
        ],
      },
      ...validProducts.map((p) => ({
        "@type": "Product",
        ...
        "offers": {
          "@type": "Offer",
          "url": p.url || `https://lemonskn.com/lt/${slug}`,
